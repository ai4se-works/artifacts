...
\node[event,right=4mm of w4] (close) {\textbf{Closeout}\\early Aug.\\Explore passed};
...
closeout passed the Explore gate and opened Consolidation; it did not pass
Scale admission.}
...
gates, paraphrased normative clauses, and declared v1 gaps) is released with
...
(CC-BY-4.0).
The pack includes a gate rubric (G1/G2), a public L1 method card (chapter map,
principles, artifact chain, process gates, paraphrased normative clauses, and
